...
/*
** These functions will control projection paramaters, e.g. theta angle, zoom
** distance. SPEED is defined in the header file and controls how much movement
** is done. Additional functions can be found in user_changes.c
*/
